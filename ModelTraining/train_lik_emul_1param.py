...
fname_summary_net_state_dict = os.path.join(SUMNETDIR, "posterior_mean_summary_statistic_shifted_hrf.pth")
...
for epoch in range(num_epochs):
	...
	if epoch % 10000 == 0:
		...
		fname_lik_model_state_dict = os.path.join(LIKEMULDIR, "likelihood_emulator_posterior_mean_summary_shifted_hrf_epoch_%s.pth" % epoch)
		torch.save({
					"epoch": epoch,
